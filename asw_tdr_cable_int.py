        ...
        for index_switch in range(1, i_s_d_item + 1):
            ...
            for index_port in range(1, 49):
                ...
                for key, item in result.items():
                    ...
                    if itemstring.__contains__("connected") == True:
                        commands = []
                        commands.append(
                            "test cable-diagnostics tdr interface gi{}/0/{}".format(
                                index_switch, index_port
                            )
                        )
                        result = send_show_command(
                            i_s_d_key, "user", "password", "password", commands
                        ...
                        commands = []
                        commands.append(
                            "show cable-diagnostics tdr interface gi{}/0/{}".format(
                                index_switch, index_port
                            )
                        )
                        result = send_show_command(
                        ...
                        for key, item in result.items():
                            ...
                            itemlist = itemtext.split()
                            itemstring = " ".join(itemlist)
                            cnt = Counter(itemlist)
                            if cnt["Normal"] == 1 or cnt["Normal"] == 3:
